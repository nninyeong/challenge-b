    ...
    <>
      ...
      <div className='flex flex-col gap-2'>
        <div className='flex justify-between'>
          <label className='flex justify-start pt-2 text-[14px] w-14 mr-4 text-gray-700'>버스</label>
          <textarea
        ...
        <div className='flex justify-between w-full gap-4'>
          <label className='flex justify-start pt-2 text-[14px] w-14 text-gray-700'>지하철</label>
          <textarea
            placeholder='오시는 길 내용을 입력하세요.'
