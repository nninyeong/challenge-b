    ...
    <>
      ...
      <div>
        ...
        <label className='flex items-center gap-2 mb-[14px]'>
          ...
          />
          <div
            className={`relative w-[43px] h-[30px] rounded-full cursor-pointer transition-colors duration-300 ${dDayCondition ? 'bg-primary-300' : 'bg-gray-400'}`}
          >
            <div
              className='absolute w-[18px] h-[18px] bg-white rounded-full top-1.5 left-1.5 transition-transform duration-300 transform-gpu'
          ...
          <span className={`${dDayCondition ? 'text-primary-300' : 'text-gray-400'}`}>
      ...
      <div>
        ...
        <label className='flex items-center gap-2 mb-[14px]'>
          ...
          />
          <div
            className={`relative w-[43px] h-[30px] rounded-full cursor-pointer transition-colors duration-300 ${attendanceCondition ? 'bg-primary-300' : 'bg-gray-400'}`}
          >
            <div
              className='absolute w-[18px] h-[18px] bg-white rounded-full top-1.5 left-1.5 transition-transform duration-300 transform-gpu'
          ...
          <span className={`${attendanceCondition ? 'text-primary-300' : 'text-gray-400'}`}>
