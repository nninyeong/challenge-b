...
const KakaoPayModal: React.FC<ModalProps> = ({ isModalOpen, value, onClose, onSave, onChange }) => {
  ...
  return (
    ...
    >
      <div
        className='bg-white p-4 lg:px-9 lg:py-8 rounded-md w-[343px] lg:w-[612px]'
      ...
      >
        ...
        <div
          className='relative cursor-pointer w-full h-[355px] flex justify-center items-center overflow-hidden lg:mb-4 lg:gap-6'
          onClick={toggleFlip}
        >
          <img
            ...
            } lg:translate-x-0 lg:z-10 lg:relative`}
          />
          <img
        ...
        <h2 className='text-[16px] font-bold mb-2 lg:mb-[14px]'>카카오페이 등록</h2>
        <input
          type='text'
          value={value}
