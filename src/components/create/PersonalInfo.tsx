...
export const PersonalInfo = ({ type }: Props) => {
  ...
  return (
    <div className='flex flex-col gap-3 text-[12px] text-gray-900'>
      <div className='flex items-center gap-1'>
        <input
          type='text'
          placeholder={type === 'groom' ? '신랑' : '신부'}
          {...register(`personalInfo.${type}.relation`)}
          className='h-[32px] w-[72px] desktop:w-[81px] pl-[8px] py-[9px] border-[.5px] border-gray-300 rounded-[8px]'
          maxLength={5}
        />
        <input
          type='text'
          ...
          className='h-[32px] w-[72px] desktop:w-[112px] pl-[8px] py-[9px] border-[.5px] border-gray-300 rounded-[8px]'
          maxLength={5}
        />
        <input
          type='text'
          ...
          className='h-[32px] w-[151px] desktop:w-[259px] pl-[8px] py-[9px] border-[.5px] border-gray-300 rounded-[8px]'
          maxLength={15}
        />
      </div>
      ...
      <div>
        ...
        <div className='flex justify-end items-center gap-[6px] mt-[8px]'>
          ...
          />
          <label className='text-gray-400 text-[12px]'>故</label>
        </div>
      </div>
      <div>
        <div className='flex items-center gap-1'>
