...
const BrandingCarouselItem = ({ src, description }: { src: string; description: string }) => {
  return (
    <div className='relative w-full aspect-square desktop:h-[588px] flex-shrink-0'>
      ...
      ></div>
      <p className='absolute bottom-[32px] desktop:bottom-[80px] ml-[10%] mobile:ml-[40px] desktop:ml-[152px] text-[20px] mobile:text-[28px] desktop:text-[48px] leading-[120%] text-white font-semibold whitespace-pre-line'>
        {description}
      </p>
    </div>
  );
