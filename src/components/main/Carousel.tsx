        ...
        {extendedReviewArr.map((review, index) => {
          ...
          return (
            <div
              ...
              className='mx-[8px]'
            >
              <div className='relative w-[216px] h-[192px] rounded-t-xl overflow-hidden shadow-md'>
                {imgUrls.length > 0 && (
                  <Image
                    src={imgUrls[0]}
                    alt='리뷰 이미지'
              ...
              <div className='w-[216px] h-[136px] bg-white rounded-b-xl p-[16px] text-[12px] shadow-md'>
