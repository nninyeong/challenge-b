  ...
  return (
    <div className='w-full desktop:w-[664px] desktop:h-[228px] h-[152px] flex mx-auto rounded-xl shadow-sm shadow-gray-400 p-[16px] relative '>
      {invitationCard ? (
        <div className=' flex desktop:justify-center justify-between items-center gap-[26px] mobile:gap-[32px] desktop:gap-[56px]'>
          ...
          <div className='flex flex-col justify-between desktop:w-[420px]'>
            ...
            <div className='flex gap-[8px] items-center mb-[8px]'>
              <div className='flex gap-[4px] desktop:gap-[4px] border border-solid border-gray-200 pt-[4px] pb-[4px] pl-[6px] pr-[6px] rounded-[24px]'>
                <img
                  src='/assets/images/icons/link-icon.webp'
                  alt='청첩장 공유하기'
                  className='w-[17px] h-[17px] mobile:w-[18px] mobile:h-[18px] desktop:w-[24px] desktop:h-[24px]'
                  loading='lazy'
                />
                <button
                  onClick={handleCopyLink}
                  className='text-[11px] mobile:text-[12px] desktop:text-[14px] text-gray-400 white-space-nowrap'
                >
                  공유하기
                </button>
              </div>
        ...
        <div className='w-full flex flex-col justify-center items-center desktop:w-[664px] desktop:h-[228px]'>
          <Image
